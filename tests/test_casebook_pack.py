"""Regression checks for the meridian-parse-csv-mark casebook."""
...
from casebook.harness import assert_expected, meridian_parse_csv_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_parse_csv_mark_summary(), assert_expected())
